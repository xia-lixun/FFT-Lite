...
${OBJECTDIR}/CFastBluestein.o: CFastBluestein.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CFastBluestein.o CFastBluestein.cpp
...
${OBJECTDIR}/Cdft.o: Cdft.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cdft.o Cdft.cpp
